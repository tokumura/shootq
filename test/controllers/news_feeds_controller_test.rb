...
class NewsFeedsControllerTest < ActionController::TestCase
  ...
  test "should create news_feed" do
    assert_difference('NewsFeed.count') do
      post :create, news_feed: { news_img_url: @news_feed.news_img_url, news_url: @news_feed.news_url, title: @news_feed.title }
    end
  ...
  test "should update news_feed" do
    patch :update, id: @news_feed, news_feed: { news_img_url: @news_feed.news_img_url, news_url: @news_feed.news_url, title: @news_feed.title }
    assert_redirected_to news_feed_path(assigns(:news_feed))
  end
